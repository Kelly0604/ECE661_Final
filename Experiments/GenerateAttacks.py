...
from BlackBoxAttack import RaySAttack, generate_rays_adv_loader
...
def main():
    ...
    # Generate RayS adversarial exammples
    # Parameters for RayS attack
    epsilon = 0.1
    query_budget = 1000

    # Generate adversarial examples using RayS attack
    adv_loader = generate_rays_adv_loader(
        model=model,
